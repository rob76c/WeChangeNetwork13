...
const (
	...
	certPath     = "/Users/lemillions/Desktop/WeChangeNetwork11/WeChangeTestNetwork/build/enrollments/wechangeappusers/users/robertcarrera/signcerts/cert.pem"
	tlsCertPath  = "/Users/lemillions/Desktop/WeChangeNetwork11/WeChangeTestNetwork/build/cas/wechangeappusers-ca/tlsca-cert.pem"
	peerEndpoint = "localho.st:443"
)
...
func exampleTransaction(gateway *client.Gateway) {
	...
	fmt.Printf("Submit Transaction: GetAllTransactions, creates new asset with ID, Color, Size, Owner and AppraisedValue arguments \n")

	_, err := contract.SubmitTransaction("CreateTransactionPurchase", "5", "50", "23.6935385, -32.8555598", "New York Dispensary 2", "Robert Isaac Carrera", "Pending", "2023-10-15 18:00:23", "3.5", "1800", "Flower", "50", "5", "Durban Poison", "4", ".20", "1", "PUREPU")
	if err != nil {
...
func newGrpcConnection() *grpc.ClientConn {
	...
	transportCredentials := credentials.NewClientTLSFromCert(certPool, "wechangeappusers-peer1.localho.st")
